...
namespace CustomerSupportServiceSample.Services
{
    public class CallAutomationService : ICallAutomationService
    {
        ...
        private const string SpeechToTextVoice = "ja-JP-NanamiNeural";
        private const string Greeting = "通話にご参加頂きありがとうございます。ソーラーパネルの設置方法について会話が必要とお伺いしました。";
        private const string EndCallPhraseToConnectAgent = "担当者とお話頂く通話リンクをSMSで送信します。お電話ありがとうございました。";
        private const string EndCall = "お電話ありがとうございました。こちらで失礼致します。";
        private const string CustomerQueryTimeout = "申し訳ありませんが、音声が聞こえないようです。";
        private const string NoResponse = "音声が聞こえませんのでこちらで失礼致します。";
        private const string InvalidAudio = "音声が聞こえませんのでこちらで失礼致します。";
