...
namespace CustomerSupportServiceSample.Services
{
    public class OpenAIService : IOpenAIService
    {
        ...
        {
            var systemPrompt = "あなたは有能なアシスタントです。";
            var baseUserPrompt = "'はい'か'いいえ'で回答します: {0} は {1} と同じ意味ですか?";
            ...
            var isMatch = response.ToLowerInvariant().Contains("はい");
        ...
        {
            var systemPrompt = "あなたは有能なアシスタントです。";
            var summaryPrompt = "お客様とエージェントの会話を要約して下さい: {0}";
            var highlightsPrompt = "お客様とエージェントの会話のハイライトは何でしたか？: {0}";
            var actionPrompt = "この会話から考えられる次のアクションは何ですか？: {0}";
